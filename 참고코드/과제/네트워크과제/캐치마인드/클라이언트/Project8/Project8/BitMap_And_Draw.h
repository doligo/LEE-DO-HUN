...
enum bit_map
{
	...
	Waiting_room_Info, Waiting_room_ingame, Waiting_room_ingame2
};
...
private:
	...
	"Waiting_room.bmp", "Waiting_room2.bmp", "Waiting_room_Info.bmp", "Waiting_room_ingame.bmp", "Waiting_room_ingame2.bmp" };
