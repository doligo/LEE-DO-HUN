...
#define BITMAP_MAX 37
#define BITMAP_SIZE_MAX 37
...
enum bit_map
{
	...
	Waiting_room_Info, Waiting_room_ingame, Waiting_room_ingame2, Select_Character_Name1, Select_Character_Name2, Select_Character_Name3, White_BackGround, 
	White_BackGround_Name
};
...
private:
	...
	"Waiting_room.bmp", "Waiting_room2.bmp", "Waiting_room_Info.bmp", "Waiting_room_ingame.bmp", "Waiting_room_ingame2.bmp", "Select_Character_Name1.bmp", "Select_Character_Name2.bmp", "Select_Character_Name3.bmp", "White_BackGround.bmp" , "White_BackGround_Name.bmp" };
