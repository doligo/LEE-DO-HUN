...
template <typename T> T* Std_manager<T>::m_stmanager = NULL;
...
template <typename T>
void Std_manager<T>::showStudent()
{
	for (int i = 0; i < 30; i++)
	{
		if (std[i]->getnum() != 0)
